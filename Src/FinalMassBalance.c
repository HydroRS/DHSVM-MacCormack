		      ...
		      OPTIONSTRUCT * Options, float roadarearatio)
{
  ...
  /* compared with the MassBalance, Output = Mass->CumChannelInt + Mass->CumRoadInt + Mass->CumET;
     and  Input = Mass->CumPrecipIn + Mass->CumSnowVaporFlux + Mass->CumCulvertReturnFlow;
     Commented by LING ZHANG 2016/9/18 */
