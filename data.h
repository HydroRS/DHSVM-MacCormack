...
typedef struct {
  ...
  int Routing;                   /* Overland flow routing indicator, either CONVENTIONAL or KINEMATIC */
                                 ...
                                 /** Added by Ling Zhang, 2016/8/28 */
  int KWFiniteDifference;        /* EXPLICITLINEAR = 1; HUANGMACCORMACK = 2; TSENGMACCORMACK = 3 */
  float IterationTimeStep;       /* Minimum iteration time step for finite difference */
